...
Knockback.Store = (function() {
  ...
  Store.prototype.destroy = function() {
    var value, _i, _j, _len, _len1, _ref, _ref1;
    this.keys = null;
    _ref = this.values;
  ...
  Store.resolveFromOptions = function(options, value) {
    ...
    return options.store.add(options.store_key, value);
  };
...
Knockback.CollectionObservable = (function(_super) {
  ...
  CollectionObservable.prototype._onModelRemove = function(model) {
    ...
    return this.trigger('remove', target, observable);
  };
  ...
  CollectionObservable.prototype._clear = function(silent) {
    var observable, targets;
    observable = kb.utils.wrappedObservable(this);
    if (!silent) {
      this.trigger('remove', observable());
    }
    return targets = observable.removeAll();
  };
...
Knockback.Observables = (function() {
  ...
  function Observables(model, mappings_info, view_model, options_or_read_only) {
    var is_string, mapping_info, read_only, view_model_property_name, _ref, _ref1;
    this.model = model;
    ...
    if (!!options_or_read_only && ((_.isBoolean(options_or_read_only) && !options_or_read_only) || !options_or_read_only.read_only)) {
      ...
      _ref1 = this.mappings_info;
      for (view_model_property_name in _ref1) {
        mapping_info = _ref1[view_model_property_name];
        this[view_model_property_name] = this.view_model[view_model_property_name] = kb.observable(this.model, mapping_info, this.view_model);
      }
    }
  }
